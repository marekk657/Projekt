...
<body>
	<form:form name="piirivalvur" method="POST" modelAttribute="piirivalvurform">
 
      <table width="400" border="0" cellspacing="0" cellpadding="0" style="margin-left:50px;">
 	<form:input type="hidden" path="id"  />
  <tr>
    <td width="168"> 
        <form:label path="sodurikood" >Sõduri kood:</form:label>
         <br>
        <form:input path="sodurikood" />  
    </td>
    <td width="280">
  ...
  <tr>
    <td> 
   		 <form:label path="Isikukood:" >Isikukood:</form:label>
    	 <br>
        <form:input path="Isikukood" />
    </td>   
    <td>
  ...
  <tr>
    <td>
    <form:label path="Eesnimi:" >Eesnimi:</form:label>
     <br>
    <form:input path="Eesnimi" />
    </td>
    <td>
    <form:label path="Aadress:" >Aadress:</form:label>
     <br>
    <form:input path="Aadress" /> 
    </td>
  </tr>
  
  <tr>
    <td>
    <form:label path="Perekonnanimi:" >Perekonnanimi:</form:label>
     <br>
    <form:input path="Perekonnanimi" /> 
    
    <form:label path="Sugu" >Sugu:</form:label>
     <br>
    <form:option path="Sugu"/>         
     </td>   
    <td>
    <p>
  ...
  <tr>
    <td ><input name="Salvesta" onclick="addRecord(${piirivalvurform.id})" type="submit" value="Salvesta" class="buttons" style="float:right;"></td>
...
<c:if test="${piirivalvurAdded == true }">
		<br/><br/><div>Uus Piirivalvur on lisatud. Vaata <a href="Piirivalvurid">kõiki piirivalvureid</a></div><br />

	</c:if>
	<c:if test="${piirivalvurModified == true }">
		<br/><br/><div>Piirivalvur muudetud. Vaata <a href="Piirivalvurid">kõiki piirivalvureid</a></div><br />
